...
GitLocalize is still far from perfect, and what we need now is as much feedback as possible. Feel free to sign in or sign up with your GitHub account, add a new repo, and start translating right away. Our team will be more than happy to answer any questions — [join the community chat](https://app.gitter.im/#/room/#gitlocalize:gitter.im) or [book a call](https://calendly.com/is-alconost) to share your experience!
